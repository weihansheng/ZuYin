...
import com.project.zuji.widget.XListView;
import com.project.zuji.widget.XListView.IXListViewListener;
...
public class MyrouteFragment extends Fragment implements IXListViewListener{
    ...
    private void setUpViews() {
		...
		View ignored_view = rootView.findViewById(R.id.list_layout);
