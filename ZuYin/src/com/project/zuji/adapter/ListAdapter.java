...
public class ListAdapter extends BaseAdapter {
	...
	public View getView(final int position, View convertView, ViewGroup parent) {
		...
		if (convertView == null) {
			...
			holder.ivMethod=(ImageView) convertView.findViewById(R.id.list_item_img);
		...
		String tripMethod=news.getTripMethod().toString();
		if (tripMethod.equals("汽车")) {
			holder.ivMethod.setImageResource(R.drawable.img_car);
		}else if (tripMethod.equals("骑车")) {
			holder.ivMethod.setImageResource(R.drawable.img_bike);
		}else {
			holder.ivMethod.setImageResource(R.drawable.img_walk);
		}
